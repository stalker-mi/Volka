package 
{
    ...
    public class Root extends Sprite
    {
		 ...
		 public function start(assets:AssetManager):void
        {
			...
			//var g:GridDisplay = new GridDisplay("layer2", 10, 10, 64, 32, "isometric");
			var g:GridDisplay = grid;
			var sprite:IsoDisplay = new IsoMovieClip(myAssets.ASSETS_GRASS, "sprite_grass", grid.toLayerPt(1, 1));
			//g.add(sprite);
			//trace(grid.getCell(1, 1)[0]);
			//g.add(grid.getCell(1, 1)[0]);
			//isoHill.addLayer(0, grid);
			isoHill.addLayer(0, g);
		...
		private function init_grid():void {
			...
			grid.flatten();
			var SCREEN_COLS:int = 10;
			var SCREEN_ROWS:int = 10;
			var screenMatrix:Matrix = new Matrix(SCREEN_COLS, SCREEN_ROWS);
